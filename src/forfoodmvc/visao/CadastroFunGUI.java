...
public class CadastroFunGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Telefone", "Endereço", "CPF", "Cargo", "Codigo Funcionario"
            }
        ) {
    ...
    private void jButtonReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReturnActionPerformed
        loginBOOLEAN1 = new LoginGUI().isLoginBOOLEAN();
        if (loginBOOLEAN1 == true) {
            new LoginGUI().setVisible(true);
            this.dispose();
        } else if (loginBOOLEAN1 == false) {
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        FuncionarioControle funcionarioControl = new FuncionarioControle();
        funcionarioControl.removerControle(f);
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        for (Funcionario arrF1 : arrF) {
            if (arrF1.getFunCpf() == Integer.parseInt(jFormattedTextField1.getText().toString())) {
                ...
                funcionarioControl.alterarControle(f);
    ...
    private void preencherTabela(List<Funcionario> funcionario) {
        ...
        for (Funcionario c : funcionario) {
            modeloTable.addRow(new Object[]{c.getFunNome(), c.getFunFone(), c.getFunEndereco(), c.getFunCpf(), c.getCargo().getCarNome(), c.getFunCodigo()});
        }
    ...
    private void preencherComboBox() {
        List<Cargo> arrF = null;
        arrF = cargoControl.listarControle();
