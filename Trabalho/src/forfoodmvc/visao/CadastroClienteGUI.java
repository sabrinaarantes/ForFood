...
public class CadastroClienteGUI extends javax.swing.JFrame {
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
       ...
       jTable1.setValueAt(jTextFieldCpf.getText(), linha, 1);
       jTable1.setValueAt(Float.parseFloat(jTextFieldTelefone.getText()), linha, 2);
       jTable1.setValueAt(jTextFieldEndereco.getText(), linha, 3);
    ...
    private void preencherTabela(ArrayList<Cliente> cliente) {
        ...
        for (Cliente c: cliente) {
            modeloTable.addRow(new Object[]{c.getNome(),c.getCpf(),c.getTelefone(),c.getEndereco()});
        }
    ...
    private void listar() {                                         
        ClienteControle clienteControl = new ClienteControle();
        listaCliente = clienteControl.listarClientes();
